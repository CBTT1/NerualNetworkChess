...
nn = NN(layer=[6, 20, 20, 20, 20, 2],active_function='relu',batch_size = 100,learning_rate = 0.001,optimization_method='RMSPropNM', batch_normalization = 1, objective_function='Cross Entropy')
epoch = 0
maxAccuracy = 0
totalAccuracy = []
totalCost = []
